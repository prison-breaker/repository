...
public:
	...
	virtual void ProcessInput(const shared_ptr<CMissionUI>& Entity, float ElapsedTime, UINT InputMask);
	virtual void Update(const shared_ptr<CMissionUI>& Entity, float ElapsedTime);
